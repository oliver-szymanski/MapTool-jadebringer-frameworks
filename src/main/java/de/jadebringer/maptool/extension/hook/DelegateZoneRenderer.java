...
class DelegateZoneRenderer extends ZoneRenderer {
  ...
  public void setZoneScale(Scale scale) {
    if (wrapped == null) return; // happens during initialization
  ...
  public DropTarget getDropTarget() {
    if (wrapped == null)
      return EventDispatcher.getCurrentZoneRenderer()
          .getDropTarget(); // happens during initialization
  ...
  public boolean isManagingFocus() {
    if (wrapped == null)
      return EventDispatcher.getCurrentZoneRenderer()
          .isManagingFocus(); // happens during initialization
